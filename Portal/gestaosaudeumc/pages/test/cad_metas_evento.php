...
?>
    ...
    <div class="box box-info">
            <div class="box-header with-border">
              <?php echo $popUp; ?>
              <h3 class="box-title">Cadastro de metas com eventos</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <form role="form" method="POST" action="recebeAtividade.php">
              <div class="box-body">
                ...
                <!-- TODO colocar aqui um campo para um numerico e um select com data, hora, minuto
                      Fazer lógica para receber esses dados
                    -->
                <div class="form-group">
                  <label for="Periodo">Selecione o período para completar:</label>
                  <input type="number" min="1" required name="numPeriodo" class="form-control"><br>
                  <select select="MedidaEscolhida" class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                ...
                <!-- TODO Se é evento permitir preencher datas e tempo de duração senão
                permitir preencher apenas quantidade (km/Metro/numero(pulos))
               -->
               <!-- TODO Adicionar div com mapa para seleção de local de evento -->
               <!-- TODO Separar Metas de evento e não evento -->


                <!-- Date dd/mm/yyyy -->
                <div class="form-group">
                  <label>Período de duração:</label>
                  <p class="help-block">Data de :</p>
                ...
                <!-- /.form group -->
                <p class="help-block">Data até (dd/mm/aaaa):</p>
                <!-- Date mm/dd/yyyy -->
                <div class="form-group">
                  <div class="input-group">
                    <div class="input-group-addon">
